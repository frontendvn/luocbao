...
FCKConfig.ToolbarSets["MyToolbar"] = [
        ['Undo','Redo','-','Bold','Italic','Underline','StrikeThrough','OrderedList','UnorderedList',
		 '-','Outdent','Indent','Link','Unlink','Anchor','FitWindow','SelectAll'],
        ['Style','FontName','FontSize','TextColor','BGColor'],
		['JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','-','Table','Image','Flash','Rule','SpecialChar','Smiley','Source','PageBreak']
] ;

FCKConfig.ToolbarSets["AdminTool"] = [
        ['Undo','Redo','-','Bold','Italic','Underline','StrikeThrough','Subscript','Superscript','OrderedList','UnorderedList',
		 '-','Outdent','Indent','Link','Unlink','Anchor','FitWindow','SelectAll'],
        ['Style','FontName','FontSize','TextColor','BGColor'],
		['JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','-','Table','Image','Flash','Rule','SpecialChar','Smiley','Source','PageBreak','Find','Preview']
] ;
FCKConfig.ToolbarSets["CustomerTool"] = [
        ['Undo','Redo','-','Bold','Italic','Underline','StrikeThrough','Subscript','Superscript','OrderedList','UnorderedList',
		 '-','Outdent','Indent','Link','Unlink','Anchor','FitWindow','SelectAll'],
        ['Style','FontName','FontSize','TextColor','BGColor'],
		['JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','-','Table','Image','Rule','SpecialChar','Smiley','PageBreak','Find','Preview']
] ;
