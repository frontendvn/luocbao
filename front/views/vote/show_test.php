...
<link rel="stylesheet" href="/Resource/Common/Default.css" type="text/css">
<meta name="description" content="VnExpress - Vietnam News Daily">
<title>VnExpress - Ket qua Bieu quyet</title>
</head>
	...
	<table width="100%" cellspacing=0 cellpadding=0 border=0 id="AdImg" style="background-color:#f4f5f6">
		<form name="frmImgCode" id="frmImgCode" method="post" onsubmit="return doSubmit();">
			...
			<input type=hidden name=fReferer id=fReferer value="http://vnexpress.net/Service/Vote/Default.Asp">
			<tr>
...
<td  bgcolor="#ffffff" class=VoteShow align=right>5,227&nbsp;phi&#7871;u</td>
</tr>
<tr height=22>
...
<tr height=25><td bgcolor="#ffffff" colspan=3 align=right class=VoteShow>T&#7893;ng c&#7897;ng: 15,945&nbsp;phi&#7871;u</td></tr>
</table>
<table width="100%" cellspacing=0 cellpadding=0 border=0>
<tr>
