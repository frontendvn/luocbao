...
(function() {
	...
	tinymce.create('tinymce.themes.AdvancedTheme', {
		...
		stateControls : ['bold', 'italic', 'underline', 'strikethrough', 'bullist', 'numlist', 'justifyleft', 'justifycenter', 'justifyright', 'justifyfull', 'sub', 'sup', 'blockquote','forecolor','forecolorpicker'],
