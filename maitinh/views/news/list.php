...
<table width="100%" cellspacing="0" cellpadding="0" >
	<tr>
		<td class="tdrow3">Từ khóa cần tìm  <input type="text" name="keyword" value="" size="40" /> Tìm trong chuyên mục <?php echo $the_select_box_search?> <input type="submit" name="btn_search" value="Tìm kiếm" /></td>
	</tr>
</table>
</form>
<br />
...
<table width="100%" cellspacing="0" cellpadding="0" >
	<tr>
		<td colspan="6" class="maintitle"><form method="post">Danh sách bản tin trong <?php echo $the_select_box.' '.anchor($this->mod.'/add/'.$cid, "&raquo; Thêm mới")?></form></td>
	</tr>
<?php
