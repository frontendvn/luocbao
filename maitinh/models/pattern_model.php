<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
 ...
 class pattern_model extends Model {
	var $_table_class = 'news_pattern';
    function pattern_model()
	...
	{//get all introduce		
		...
		$sql = "SELECT 
					id_pattern, name, html_open, html_close, website, title_open, title_close, intro_open,
					intro_close, content_open, content_close, author_open, author_close, times, time_update, weight 
